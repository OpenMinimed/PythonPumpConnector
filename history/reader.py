...
class IddRacpOpCode(IntEnum):
    REPORT_RECORDS = 0x33  # 51
    DELETE_RECORDS = 0x3C  # 60
    ABORT_OPERATION = 0x55  # 85
    REPORT_NUMBER_OF_RECORDS = 0x5A  # 90
    NUMBER_OF_RECORDS_RESPONSE = 0x66  # 102
    RESPONSE_CODE = 0x0F  # 15

class IddRacpOperator(IntEnum):
    NULL = 0x0F  # 15
    ALL_RECORDS = 0x33  # 51
    LESS_OR_EQUAL = 0x3C  # 60
    GREATER_OR_EQUAL = 0x55  # 85
    WITHIN_RANGE = 0x5A  # 90
    FIRST_RECORD = 0x66  # 102
    LAST_RECORD = 0x69  # 105

class IddRacpFilterType(IntEnum):
    SEQUENCE_NUMBER = 0x0F  # 15
    SEQUENCE_NUMBER_REF_TIME_EVENTS = 0x33  # 51
    SEQUENCE_NUMBER_NON_REF_TIME_EVENTS = 0x3C  # 60

class IddRacpResponseCode(IntEnum):
    SUCCESS = 0xF0  # 240
    OP_CODE_NOT_SUPPORTED = 0x02  # 2
    INVALID_OPERATOR = 0x03  # 3
    OPERATOR_NOT_SUPPORTED = 0x04  # 4
    INVALID_OPERAND = 0x05  # 5
    NO_RECORDS_FOUND = 0x06  # 6
    ABORT_UNSUCCESSFUL = 0x07  # 7
