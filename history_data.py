...
class AnnunciationType(BaseEnum):
    ...
    INSERT_BATTERY_ALERT                  = 0x0054  # guessed from pump alert "Insert battery"
    CHECK_BOLUS_BG_ALERT                  = 0x0067
    LOW_BATTERY_PUMP_ALERT                = 0x0068  # guessed from pump alert "Low battery Pump"
    ...
    CALIBRATION_NOT_ACCEPTED_ALERT        = 0x0308  # guessed from pump alert "Calibration not accepted"
    CHANGE_SENSOR_1                       = 0x0309
    CHANGE_SENSOR_2                       = 0x030a
    LOST_SENSOR_SIGNAL_ALERT              = 0x030c  # guessed from pump alert "Lost sensor signal"
    NO_SG_CALIBRATION_OCCURRED            = 0x0312
    CHANGE_SENSOR_3                       = 0x0315
    SENSOR_CONNECTED_ALERT                = 0x031e  # guessed from pump alert "Sensor connected"
    ...
    HIGH_SG_FOR_3_HOURS_ALERT             = 0x0344  # guessed from pump alert "High SG"
