...
class PumpAdvertiser():
    ...
    def __init__(self, mobile_name:str=None, already_paired:bool=False, instance_id:int=1, use_adv_interval_hack:bool=True):
        """
        ...
        if already_paired and use_adv_interval_hack:
